...
while True:
    ...
    ##remove the file name if sqlmap scan finished.
    if 'txt' in string_data:
        os.remove(os.path.join('/home/user-server/sqlmap/',string_data))
        #print("Remove ", string_data, " successfully.")
    ## receive the file content of post methods
    else:
        # write the string to a file
        f = open(os.path.join('/home/user-server/sqlmap/',str(count)+'.txt'), 'w+')
        f.write(string_data)
